            ...
            <div class="btm-box">
                ...
                <div class="bank-info">
                    ...
                    <p class="info-content">
                        ...
                        <span>예금주 : (주)team_2</span>
                    </p>
                </div>
                <div class="btm-icon">
                    <ul class="btm-icon-list">
                        <li><a href=""><img class="icon" src="icon/icon_quick1.png" alt=""></a></li>
                        <li><a href=""><img class="icon" src="icon/icon_quick2.png" alt=""></a></li>
                        <li><a href=""><img class="icon" src="icon/icon_quick3.png" alt=""></a></li>
                        <li><a href=""><img class="icon" src="icon/icon_quick4.png" alt=""></a></li>
                        <li><a href=""><img class="icon" src="icon/icon_quick5.png" alt=""></a></li>
                    </ul>
                </div>
            </div>
